...
#
# Compared to models1, the TPL model reduces the input dimension to 1/4 not 1/2
...
#
# tpl unet (第4MaxPoolingをTPL、transposeConvd2dをTPL)
#
def tpl_unet_model(input_size=(128, 128, 3), c=32, leaky_relu=False):
    inputs = layers.Input(input_size)
    
    # size of TensorProjectionLayer
    tpl_size_h = input_size[0] // 32  # height
    tpl_size_w = input_size[1] // 32  # width
    ...
    # Decoder
    u4 = TransposeTensorProjectionLayer(tpl_size_h*4, tpl_size_w*4, c*8)(c5)  # (tpl_size_h*4, tpl_size_w*4, c*8)
